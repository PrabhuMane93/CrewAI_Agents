# Replication of the tool shown here: https://github.com/joaomdmoura/crewAI-tools/tree/main/crewai_tools/tools/file_read_tool
...
file_read_tool = FileReadTool(file_path='testingFile.txt')
print(file_read_tool.run())